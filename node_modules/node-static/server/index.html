<html>
  ...
  <body>
    <div class='login-wrap'>
      <div class='author'>
        <img class='person-avatar' src='images/users/anonim.png'>
  ...
  <script id='offer-templ' type='text/x-handlebars-template'>
    <div class='lightbox offer' data-id='{{id}}'>
      <div class='lightbox-header'>
        <div class='author'>
          <img class='person-avatar' src='{{author.0.avatar}}'>
          <div class='personal-content'>
        ...
        <div class='close-item'>
          <span class='icon fa fa-times' data-button='closeOfferLightbox'></span>
          <span class='content' data-button='closeOfferLightbox'>Закрыть</span>
        </div>
      </div>
