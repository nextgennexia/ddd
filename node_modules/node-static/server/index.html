      ...
      <div class='lightbox-body'>
        ...
        <div class='comments {{#if states.hiddenAnswers}}hidden{{/if}}'>
          <div class='latest-comments'>
            {{#renderLatestMessages answers.0.fromUsers 3}}
          ...
          <div class='add-answer'>
            <div class='author'>
              ...
              <div class='content'>
                <textarea class='field-textarea js-answer' data-id='{{id}}' maxlength='500' placeholder='Комментировать'></textarea>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class='js-offer-card-wrap' data-id='{{id}}'>
    <div class='offer-plate'>
      ...
      <div class='social-actions'>
        ...
        <div class='1}active{/if} fa fa-heart item {#if'></div>
      </div>
      <div class='offer-content'>
        ...
        <div class='social-info'>
          {{#if likes.0.fromUsers.length}}
          <span class='item count-likes'>{{likes.0.fromUsers.length}} нравится</span>
          {{/if}}
          {{#if comments.0.count}}
        ...
        <div class='comments {{#if states.hiddenComments}}hidden{{/if}}'>
          <div class='latest-comments'>
            {{#renderLatestMessages comments.0.fromUsers 5}}
            <div class='author' data-id='{{id}}'>
              <img class='avatar' src='{{avatar}}'>
              <div class='content'>
                {{#trancate comment 40}}
          ...
          <div class='add-comment'>
            <div class='author'>
              <img class='avatar' src='{{user.avatar}}'>
              <div class='content'>
                <input class='field-text js-comment' data-id='{{id}}' placeholder='Комментировать' type='text'>
              </div>
            </div>
          </div>
        </div>
