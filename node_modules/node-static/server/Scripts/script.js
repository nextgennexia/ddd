...
function Offer(self) {
  ...
  this.viewComment = function ($target) {
    $offerPlate.find('.comments').toggleClass('hidden');
...
function renderOffer(id) {
  ...
  $.each(offers, function () {
    if (this.id == id) {
      ...
      renderTemplate('#lightbox-social-buttons-templ', '.lightbox.offer[data-id="' + id + '"] .social-actions', this);
      renderTemplate('#latest-answers-templ', '.lightbox.offer[data-id="' + id + '"] .latest-comments', this);
      renderTemplate('#lightbox-social-info-templ', '.lightbox.offer[data-id="' + id + '"] .lightbox-footer', this);
    }
  });
...
function renderShortOffers() {
  ...
  while (index < offers.length) {
    $.each(columns, function () {
      ...
      renderTemplate('#social-buttons-templ', '.offer-plate[data-id="' + currentOfferId + '"] .social-actions', offers[index]);
      renderTemplate('#social-info-templ', '.offer-plate[data-id="' + currentOfferId + '"] .social-info', offers[index]);
      renderTemplate('#latest-comments-templ', '.offer-plate[data-id="' + currentOfferId + '"] .latest-comments', offers[index]);
      index += 1;
